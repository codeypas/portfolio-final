...
const UPLOAD_BASE_URL = import.meta.env.VITE_UPLOAD_BASE_URL || "https://mybio-backend.onrender.com"
...
api.interceptors.response.use(
  ...
  (error) => {
    ...
    if (error.code === "ECONNREFUSED" || error.code === "ERR_NETWORK") {
      console.error("Backend server is not running or unreachable. Using fallback data.")
    }
